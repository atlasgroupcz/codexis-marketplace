...
cdx -s "cdx://doc/CR26785/text" | grep -i "smlouva"

# Find with context
cdx -s "cdx://doc/CR26785/text" | grep -B2 -A5 "§ 89"
```
...
```bash
# Get first 100 lines
cdx -s "cdx://doc/CR26785/text" | head -100

# Get lines 500-600
cdx -s "cdx://doc/CR26785/text" | sed -n '500,600p'

# Get last 50 lines
cdx -s "cdx://doc/CR26785/text" | tail -50
```
...
# Get old version
cdx -s "cdx://doc/${DOC_ID}_2020_01_01/text" > /tmp/old.txt
