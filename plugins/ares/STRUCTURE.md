...
- `README.md` - short project overview, final CLI command surface and implementation boundaries.
...
- `lib/ares_cli/client.py` - future HTTP boundary for ARES REST calls.
- `lib/ares_cli/errors.py` - shared user-facing exception type.
- `lib/ares_cli/formatters.py` - future normalization of raw ARES responses into legal-domain JSON.
- `lib/ares_cli/models.py` - small typed contracts for entity/source records.
- `lib/ares_cli/service.py` - command-level mapping: search, company, officers, trades, owners, raw.
