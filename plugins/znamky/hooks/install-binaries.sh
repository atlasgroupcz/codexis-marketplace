...
SHARED_LIB_DIR="${HOME}/.local/share/znamky/lib"
...
install_lib "znamky_core"
install_binary "znamky-cli"

# Install Python imaging deps (best-effort; don't fail the install offline).
python3 -m pip install --user --quiet Pillow ImageHash || true
